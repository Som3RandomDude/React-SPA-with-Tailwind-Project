export default function Profile() {
    return (
        <div className="w-full relative mt-0 rounded  overflow-hidden">
            ...
            <div className="grid grid-cols-12 bg-white ">
                ...
                <div className="col-span-12 w-full px-3 py-6 justify-center flex space-x-4 border-b border-solid md:space-x-0 md:space-y-4 md:flex-col md:col-span-2 md:justify-start ">
                    ...
                    <a href="#" className="text-sm p-2 bg-indigo-200 text-center rounded font-semibold hover:bg-indigo-700 hover:text-gray-200">Posts</a>
                    ...
                    <div className="px-4 pt-4">
                        <form action="#" className="flex flex-col space-y-8">
                            ...
                            <div className="form-item">
                                ...
                                <input type="text" value="test@gmail.com" className="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2  mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200" disabled/>
                            </div>
                            ...
                            <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                                ...
                                <div className="form-item w-full">
                                    ...
                                    <input type="text" value="Howell" className="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 text-opacity-25 " disabled/>
                                </div>
                            </div>
