                                        ...
                                        <div className="grid grid-cols-3">
                                            <div className="text-center my-2">
                                                <img className="h-16 w-16 rounded-full mx-auto"
                                                    ...
                                                    alt="" />
                                                <Link to="#" className="text-main-color">Kojstantin</Link>
                                            </div>
                                            <div className="text-center my-2">
                                                <img className="h-16 w-16 rounded-full mx-auto"
                                                    src="https://widgetwhats.com/app/uploads/2019/11/free-profile-photo-whatsapp-4.png"
                                                    alt="" />
                                                <Link to="#" className="text-main-color">James</Link>
                                            </div>
                                            <div className="text-center my-2">
                                                <img className="h-16 w-16 rounded-full mx-auto"
                                                    src="https://lavinephotography.com.au/wp-content/uploads/2017/01/PROFILE-Photography-112.jpg"
                                                    alt="" />
                                                <Link to="#" className="text-main-color">Natie</Link>
                                            </div>
                                            <div className="text-center my-2">
                                                <img className="h-16 w-16 rounded-full mx-auto"
                                                    src="https://bucketeer-e05bbc84-baa3-437e-9518-adb32be77984.s3.amazonaws.com/public/images/f04b52da-12f2-449f-b90c-5e4d5e2b1469_361x361.png"
                                                    alt="" />
                                                <Link to="#" className="text-main-color">Casey</Link>
                                            </div>
                                        </div>
                                    </div>
                                    {/* <!-- End of friends card --> */}
                                            ...
                                            <div className="grid md:grid-cols-2 text-sm">
                                                ...
                                                <div className="grid grid-cols-2">
                                                    ...
                                                    <div className="px-4 py-2">
                                                        <Link className="text-blue-800" to="mailto:jane@example.com">jane@example.com</Link>
                                                    </div>
                                                </div>
                                                <div className="grid grid-cols-2">
